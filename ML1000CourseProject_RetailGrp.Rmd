...
#VK :  Can you please explain this better ? There are other ways a ticket is categorised. Is this a subset ?
...
#VK : This is nice. very clear. But we should make is clear that we work only with opened and resolved dates.
...
#VK : Make it explicit that cost for JJ increases going from L1 to L3. Do you know the factor of increase ? We are focussing
on L2 and L3 in both supervised and unsupervised learning.
